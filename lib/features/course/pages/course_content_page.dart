...
class CourseContentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (state is CourseContentSuccess) {
      final courseContent = state.courseContentModel.firstWhere(
        (s) => s.id == id,
      );
      ...
      return Scaffold(
        appBar: AppBar(),
        body: const Center(child: Text('Error loading course content')),
      );
    }
  }
}
...
class _CourseContentViewState extends State<CourseContentView>
  ...
  void initState() {
    ...
    final videoId = YoutubePlayer.convertUrlToId(
      widget.courseContent.courseContentVideoUrl,
      // 'https://www.youtube.com/watch?v=Kh_54-id9NA',
    );
  ...
  Widget build(BuildContext context) {
    ...
    final studentId = context.watch<AuthCubit>().currentUser?.id;
                                          ...
                                          children: [
                                            ...
                                            if (state is CourseContentSuccess)
                                              ContentComment(
                                                ...
                                                pageNumber:
                                                    contentCubit.pageNumber,
                                                totalPages:
                                                    contentCubit.totalPages,
